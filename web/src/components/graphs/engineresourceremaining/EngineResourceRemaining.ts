...
@Component
export default class EngineResourceRemaining extends Vue {
    /** Данные для графика */
    @Prop({ default: (): [] => [] })
    private chartData!: EngineResourceRemainingDTO[];

    /** График */
    private chart: any = null;

    /** Идентификатор контейнера для графика */
    public containerId: string = 'engine-resource-remaining';
